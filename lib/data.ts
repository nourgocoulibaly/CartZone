...
export const products: Product[] = [
  // Gaming
  {
    ...
    denominations: [6500, 13000, 33000, 65500],
    currency: "XOF",
    discount: 5,
    isFeatured: true,
    rating: 4.8,
  ...
  },
  {
    ...
    denominations: [10000, 16500, 33000, 65500],
    currency: "XOF",
    isFeatured: true,
    rating: 4.7,
    reviews: 218,
  },
  {
    ...
    denominations: [10000, 16500, 23000, 33000],
    currency: "XOF",
    isNew: true,
    rating: 4.9,
    reviews: 187,
  },
  {
    ...
    denominations: [3500, 6500, 13000, 33000, 65500],
    currency: "XOF",
    discount: 3,
    isFeatured: true,
    rating: 4.9,
  ...
  },
  {
    ...
    image: "/categories/Steam.avif",
    denominations: [6500, 13000, 23000, 33000],
    currency: "XOF",
    isNew: true,
    rating: 4.6,
    reviews: 156,
  },
  {
    ...
    denominations: [6500, 16500, 33000, 65500],
    currency: "XOF",
    rating: 4.7,
    reviews: 289,
  },
  // Music
  {
    ...
    denominations: [6500, 19500, 39500],
    currency: "XOF",
    discount: 10,
    isFeatured: true,
    rating: 4.8,
  ...
  },
  {
    ...
    denominations: [6500, 16500, 33000],
    currency: "XOF",
    rating: 4.7,
    reviews: 198,
  },
  ...
  // Streaming
  {
    ...
    denominations: [10000, 16500, 33000],
    currency: "XOF",
    isFeatured: true,
    rating: 4.8,
    reviews: 389,
  },
  {
    ...
    denominations: [10000, 19500, 39500],
    currency: "XOF",
    discount: 8,
    rating: 4.7,
    reviews: 234,
  ...
  },
  {
    ...
    denominations: [6500, 10000, 16500, 33000],
    currency: "XOF",
    rating: 4.7,
    reviews: 312,
  },
  ...
  //   image: "/categories/Spotify.webp",
  //   denominations: [6500, 16500, 26000, 46000],
  //   currency: "XOF",
  //   discount: 15,
  //   isFeatured: true,
  //   isNew: true,
  ...
  //   image: "/categories/Deezer.webp",
  //   denominations: [10000, 19500, 33000],
  //   currency: "XOF",
  //   rating: 4.4,
  //   reviews: 198,
  // },
  // Social
  {
    ...
    denominations: [3500, 6500, 16500, 33000],
    currency: "XOF",
    isNew: true,
    rating: 4.3,
    reviews: 145,
